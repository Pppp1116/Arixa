...
def to_python(prog: Program, freestanding: bool = False, overflow_mode: str = "trap") -> str:
    ...
    lines += [
        ...
        "def secure_bytes(n): return list(os.urandom(max(0, int(n))))",
        "def utf8_encode(s): return list(str(s).encode('utf-8'))",
        "def utf8_decode(bs):",
        "    try:",
        ...
        "def __secure_bytes(n): return secure_bytes(n)",
        "def __utf8_encode(s): return utf8_encode(s)",
        "def __utf8_decode(bs): return utf8_decode(bs)",
