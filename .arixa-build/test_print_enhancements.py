...
def main():
    ...
    try:
        ...
        height = 5.7
        is_student = True
        print_('=== String Interpolation Tests ===')
        print_('Hello, ' + name + '!')
        print_('Age: ' + str(age) + ' years old')
        print_('Height: ' + str(height) + ' feet')
        print_('Is student: ' + str(is_student))
        x = 10
        y = 20
        print_('Sum of ' + str(x) + ' and ' + str(y) + ' is ' + str((x + y)))
        print_('Double of ' + str(age) + ' is ' + str((age * 2)))
        print_('Name: ' + name + ', Age: ' + str(age) + ', Height: ' + str(height))
        print_('=== Variable Arguments Tests ===')
        print_('Multiple', 'arguments', 'work')
        print_('Mixed types:', 'Alice', 30, 5.7, True)
        print_('No interpolation here')
        numbers = [1, 2, 3, 4, 5]
        print_('Array length: ' + str(len_(numbers)))
        print_('First element: ' + str((numbers)[0]))
        print_('=== All Tests Passed ===')
        return 0
