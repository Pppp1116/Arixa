...
def main():
    ...
    try:
        ...
        age = 28
        score = 87.5
        print_('=== Print and Format Function Demo ===')
        print_('User profile: ' + user + ', age ' + str(age) + ', score ' + str(score))
        header = '=== ' + user + "'s Report ==="
        print_(header)
        summary = 'Level:' + ' ' + str(3) + ' ' + 'Score:' + ' ' + str(87.5) + ' ' + 'Status:' + ' ' + 'Active'
        print_(summary)
        greeting = 'Welcome, ' + user + '!'
        print_(greeting)
        bonus_score = 'Bonus score: ' + str((score * 1.1))
        print_(bonus_score)
        details = 'Details: name=' + user + ', age=' + str(age)
        print_('Full details:', details)
        print_('=== Demo Complete ===')
        return 0
