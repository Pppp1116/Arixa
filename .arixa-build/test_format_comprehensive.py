...
def main():
    ...
    try:
        ...
        score = 95.5
        passed = True
        print_('=== Format Function Tests ===')
        greeting = 'Hello, ' + name + '!'
        print_(greeting)
        result = 'Student:' + ' ' + 'Bob' + ' ' + 'Score:' + ' ' + str(95.5) + ' ' + 'Passed:' + ' ' + str(True)
        print_(result)
        message = 'Final score: ' + str((score * 2.0))
        print_(message)
        age_str = str(25)
        print_('Age as string:', age_str)
        status = str(True)
        print_('Status as string:', status)
        report = 'Report for ' + name + ': age=' + str(age) + ', score=' + str(score) + ', passed=' + str(passed)
        print_(report)
        print_('=== All Format Tests Passed ===')
        return 0
