...
def __str_char_at_impl(s, index):
    ...
    _fn.argtypes = [ctypes.c_void_p, ctypes.c_int64]
    return _fn(s, index)
...
def __str_substring_impl(s, start, length):
    ...
    _fn.restype = ctypes.c_void_p
    _fn.argtypes = [ctypes.c_void_p, ctypes.c_int64, ctypes.c_int64]
...
def __str_split_impl(s, delimiter):
    _lib = _astra_load_first_lib(['c'])
    _fn = getattr(_lib, '__str_split_impl')
    _fn.restype = ctypes.c_void_p
    _fn.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
    return _fn(s, delimiter)

def __str_trim_start_impl(s):
    _lib = _astra_load_first_lib(['c'])
    _fn = getattr(_lib, '__str_trim_start_impl')
    _fn.restype = ctypes.c_void_p
    _fn.argtypes = [ctypes.c_void_p]
    return _fn(s)

def __str_trim_end_impl(s):
    _lib = _astra_load_first_lib(['c'])
    _fn = getattr(_lib, '__str_trim_end_impl')
    _fn.restype = ctypes.c_void_p
    _fn.argtypes = [ctypes.c_void_p]
    return _fn(s)
...
def __str_join_impl(parts, delimiter):
    _lib = _astra_load_first_lib(['c'])
    _fn = getattr(_lib, '__str_join_impl')
    _fn.restype = ctypes.c_void_p
    _fn.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
    return _fn(parts, delimiter)

def main():
    try:
        return __astra_cast(str.length(text), 'i64')
...
def parse_int(s):
    try:
        return __astra_cast(__from_json(s), 'i64')
    except _AstraTryNone:
        return None
    except _AstraTryResultErr as __astra_err:
        return __astra_result_err(__astra_err.value)
...
def parse_float(s):
    try:
        return __astra_cast(__from_json(s), 'Float')
    except _AstraTryNone:
        return None
    except _AstraTryResultErr as __astra_err:
        return __astra_result_err(__astra_err.value)
def parse_bool(s):
    try:
        return __astra_cast(__from_json(s), 'Bool')
    except _AstraTryNone:
        return None
    except _AstraTryResultErr as __astra_err:
        return __astra_result_err(__astra_err.value)
